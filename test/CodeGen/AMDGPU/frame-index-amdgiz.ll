...
; CHECK: s_endpgm
  ...
  call void @llvm.lifetime.start.p5i8(i64 400, i8 addrspace(5)* nonnull %0) #2
  ...
  call void @llvm.lifetime.end.p5i8(i64 400, i8 addrspace(5)* nonnull %0) #2
  ret void
}
